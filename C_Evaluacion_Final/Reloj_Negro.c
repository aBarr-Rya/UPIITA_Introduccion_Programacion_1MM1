...
//// Reloj programacion
 ...
 int coloracion=0;system("color 0f");
	while(1){
		lala=segundos;
		segundos++;
		...
		if(lala==9||lala==19||lala==29||lala==39||lala==49||lala==59){
			...
			switch(coloracion){
				case 0:
					system("color 0D");coloracion++;
					break;
				case 1:
					system("color 0C");coloracion++;
					break;
				case 2:	
					system("color 0b");coloracion++;
					break;
				case 3:	
					system("color 06");coloracion++;
					break;
				case 4:	
					system("color 04");coloracion++;
					break;
				case 5:	
					system("color 0A");coloracion++;
					break;
				case 6:	
					system("color 01");coloracion++;
					break;
				case 7:	
					system("color 05");coloracion++;
					break;
				case 8:	
					system("color 04");coloracion++;
					break;
